			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ansible_host.host_1", "id", "host_1"),
					resource.TestCheckResourceAttr(
						"ansible_host.host_1", "groups.0", "group_1"),
					resource.TestCheckResourceAttr(
						"ansible_host.host_1", "vars.ansible_host", "1.2.3.4"),
					resource.TestCheckResourceAttr(
						"ansible_host.host_1", "vars.ansible_user", "ubuntu"),
				),
			},
		},
	})
